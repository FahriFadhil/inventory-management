        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'Laravel') }}&nbsp; &gt; &nbsp;{{ ucfirst(strtolower(Request::path())) }}
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <!-- Left Side Of Navbar -->
                    <!-- <ul class="navbar-nav mr-3 pr-3 border-right">
                        <div class="nav-item"><a href="/home" class="nav-link">Home</a></div>
                        <div class="nav-item"><a href="/item" class="nav-link">Item</a></div>
                        <div class="nav-item"><a href="/room" class="nav-link">Room</a></div>
                        <div class="nav-item"><a href="/category" class="nav-link">Category</a></div>
                    </ul> -->
